// This file can be removed entirely as prompts should be managed in the backend
// If you need to reference prompt names, consider using a simple enum instead
...
// Importing the SUMMARIZATION prompt from backend
export const SUMMARIZATION = `You are an expert complaint analyzer. Your task is to:
